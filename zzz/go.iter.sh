...
print_urls() {
  ...
  echo -e "  ${G}ds${NC}    http://127.0.0.1:8050/"
  echo -e "  ${B}M6D${NC}   http://127.0.0.1:5650/"
  echo -e "──────────────────────────────────────────────"
...
m6d)  run_m6d; open_when_ready "http://127.0.0.1:5650/" 60; wait || true ;;
