...
class EPRank(AlphaSignal):
    ...
    def compute(self, univ: Universe) -> pd.DataFrame:
        ...
        ep = ep.reindex(univ.dates, method="ffill")
...
class BPRank(AlphaSignal):
    ...
    def compute(self, univ: Universe) -> pd.DataFrame:
        ...
        bp = bp.reindex(univ.dates, method="ffill")
...
class CompositeValue(AlphaSignal):
    ...
    def compute(self, univ: Universe) -> pd.DataFrame:
        ep = univ.fundamentals["ep"].unstack("instrument").reindex(univ.dates, method="ffill")
        bp = univ.fundamentals["bp"].unstack("instrument").reindex(univ.dates, method="ffill")
...
class ROERank(AlphaSignal):
    ...
    def compute(self, univ: Universe) -> pd.DataFrame:
        ...
        roe = roe.reindex(univ.dates, method="ffill")
...
class EarningsSurprise(AlphaSignal):
    ...
    def compute(self, univ: Universe) -> pd.DataFrame:
        ...
        surp = surp.reindex(univ.dates, method="ffill")
